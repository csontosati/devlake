...
- **AI-assisted commit classification**: Precomputes which commits were authored with Cursor/Claude/Copilot/CodeRabbit (from git trailers) into `ai_commits`. Bot identity is `accounts.is_bot`, not this plugin.
